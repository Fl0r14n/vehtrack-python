...
angular.module('homepage.fleets').controller('fleetController', function($scope, config, messagingService, deviceService, userService, fleetService, $modal) {
    var self = this;
    ...
    self.device_grid = {
        ...
        columnDefs: [
            ...
            {name:'Show Journeys', displayName: '', width: 40, enableColumnMenu: false, enableFiltering: false, cellTemplate: 'show_journey_button.html'}
        ],
    ...
    $scope.isSelectedRootFleet = function() {
